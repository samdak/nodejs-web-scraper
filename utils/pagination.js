 ...
 * @return {string[]}
 */
function getPaginationUrls(address, { numPages, begin, end, offset = 1, queryString, customRouting, routingString }) {
  ...
  for (let i = firstPage; i <= lastPage; i = i + offset) {
    ...
    } else if (customRouting) {
      paginationUrl = customRouting(address, i);
    } else {
